...
package com.atomscat.opensips.event.option;
 ...
 */
@ToString
public class EventClientOption {
     ...
     */
    public EventClientOption sndBufSize(int sndBufSize) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption rcvBufSize(int rcvBufSize) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption workerGroupThread(int workerGroupThread) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption publicExecutorThread(int publicExecutorThread) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption callbackExecutorThread(int callbackExecutorThread) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption defaultTimeoutSeconds(int defaultTimeoutSeconds) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption defaultPassword(String defaultPassword) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption readTimeoutSeconds(int readTimeoutSeconds) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption readerIdleTimeSeconds(int readerIdleTimeSeconds) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption disablePublicExecutor(boolean disablePublicExecutor) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption performance(boolean performance) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption performanceCostTime(long performanceCostTime) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption eventPerformance(boolean eventPerformance) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption eventPerformanceCostTime(long eventPerformanceCostTime) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption serverConnectionListener(ServerConnectionListener serverConnectionListener) {
     ...
     * <p>addListener.</p>
     *
     * @param listener a {@link ServerEventListener} object.
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption addListener(ServerEventListener listener) {
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption removeListener(ServerEventListener listener) {
     ...
     * @return a {@link List} object.
     */
    public List<ServerEventListener> listeners() {
        return listeners;
    }
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption addEvents(String... addEvents) {
        if (addEvents == null) {
            return this;
        }
     ...
     * @return a {@link EventClientOption} object.
     */
    public EventClientOption cancelEvents() {
        if (!events.isEmpty()) {
            events.clear();
        }
        return this;
